...
import smallHitSfx from './bird_song/mixkit-small-hit-in-a-game-2072.mp3';
...
const funfacts = {
    ...
    23: 'The collective name for goldfinches is a charm.  Most pairs attempt to rear two broods a year; some rear three.',
    ...
    36: 'Little owls can be found in England, Wales and southern Scotland. They like lowland farmland with hedges and copses, parkland and orchards.',
...
function Game() {
    ...
    var rand = min + Math.floor(Math.random() * (max - min));
     console.log (rand);
    const [leftSlide, setLeftSlide] = useState(rand);   // rand
   ...
   // var game_status = 'active';
    ...
    function resetSlides() {
        ...
        if (parseInt(newLeft) !== parseInt(leftSlide)) {
            console.log('*******  error in config code *********')
        ...
        if (parseInt(newRight) !== parseInt(rightSlide)) {
            console.log('*******  error in config code *********')
                ...
                <Grid align="Center">
                    <Grid.Row columns={1} >
                        <Grid.Column>
                            ...
                            <div style={{ position: "absolute", top: "45px", left: "390px" }}>
    ...
    return (
        <>  
         ...
         <div style={{
                                ...
                                <h3 style={{ color: "white" }}>You ended on {title}! &nbsp;&nbsp;&nbsp; You scored {derivedscore} points.</h3>
